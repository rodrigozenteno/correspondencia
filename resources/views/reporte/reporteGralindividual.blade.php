...
<table width="110%">
    ...
    <tr align="center">
        ...
        <header>
            ...
            <h5>DEPARTAMENTO IV EDUCACION</h5>
            <h5 style="margin:-2.5% 0;">ESCUELA DE COMANDO Y ESTADO MAYOR</h5>
                        ...
                        <thead class="text-center" style="background-color: lightgray;">
                          ...
                          <tbody>
                            ...
                            <tr>
                                  ...
                                  <th scope="row">{{ $datos[0]->codigodocumento}} <br> {{ $dat->nombreoficina }} <br> {{ $dat->fecha }}</th>
                                  ...
                                  <?php
													 $date1 =new dateTime($datos[0]->fechaentregacmte );
